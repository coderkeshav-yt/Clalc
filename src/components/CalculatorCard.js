...
const CalculatorCard = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-white via-gray-50 to-blue-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-3xl p-6 shadow-2xl max-w-md w-full mx-auto transition-all duration-300 hover:shadow-2xl border border-gray-100 dark:border-gray-700 backdrop-filter backdrop-blur-lg transform hover:scale-[1.02] hover:-translate-y-1">
      ...
      <div className="flex flex-col space-y-4">
        <input
          ...
          value={input}
          readOnly
          className="w-full px-6 py-4 text-right text-2xl bg-white/80 dark:bg-gray-900/80 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-blue-500 dark:text-white font-mono tracking-wider shadow-inner transition-all duration-300 animate-fade-in"
        />
        ...
        <div className="mt-4 text-lg font-medium text-gray-700 dark:text-gray-300 bg-white/50 dark:bg-gray-800/50 p-4 rounded-2xl backdrop-blur-sm border border-gray-200 dark:border-gray-700 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-lg animate-fade-in">
